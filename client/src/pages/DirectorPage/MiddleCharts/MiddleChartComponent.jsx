...
import { BarChart, Bar, XAxis, YAxis, Tooltip, CartesianGrid, Legend, Label, LineChart, Line, LabelList } from 'recharts';




const MiddleChartComponent = () => {
  ...
  useEffect(() => {
    const fetchBarChartData = async () => {
      try {
        const response = await axios.get('/api/director-dashboard/bar-chart', {
    ...
    const fetchLineChartData = async () => {
      try {
        const response = await axios.get('/api/director-dashboard/line-chart', {
          params: { year, hospital_id: selectedHospital }
        });
...
export default MiddleChartComponent;
