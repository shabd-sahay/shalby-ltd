  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const sortedData = response.data.yearly_appointments.sort((a, b) => a.year - b.year); // Sort by year
        setData(sortedData);
      } catch (error) {
      ...
      <div style={{ width: '75%' }}>
        ...
        <ResponsiveContainer width="100%" height={400}>
          <LineChart data={data}>
            ...
            <XAxis dataKey="year" tickMargin={10} /> {/* Adjust the tickMargin value as needed */}
            <YAxis />
            <Tooltip />
            <Legend />
